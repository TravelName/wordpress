...
class Activation {
	...
	private function is_available_for_activation() {
		...
		$comparison_table_page_id    = intval( Mods::get( Module::MODS_COMPARISON_TABLE_TABLE_PAGE_ID, 0 ) );
	...
	protected function match_the_page( $page_id ) {
		...
		return set_theme_mod( Module::MODS_COMPARISON_TABLE_TABLE_PAGE_ID, $page_id );
	}
	 ...
	 * @return bool
	 */
	protected function set_page_options( $page_id ) {
