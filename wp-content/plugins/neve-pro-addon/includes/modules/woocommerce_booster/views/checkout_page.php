...
class Checkout_Page extends Base_View {
	...
	public function render_billing_next_step_button() {
		$label = __( 'Proceed to', 'neve' ) . ' ' . get_theme_mod( 'neve_checkout_step2_label', __( 'Order review', 'neve' ) );
		echo '
	...
	/**
	 * Renders the next step button for revieww step
	 */
	public function render_review_next_step_button() {
		$label = __( 'Proceed to', 'neve' ) . ' ' . get_theme_mod( 'neve_checkout_step3_label', __( 'Payment', 'neve' ) );
		echo '
