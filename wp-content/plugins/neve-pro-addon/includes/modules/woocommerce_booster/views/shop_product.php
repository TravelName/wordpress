...
class Shop_Product extends Abstract_Shop_Product {
	...
	public function wrap_image_buttons() {
		...
		echo '<a href="' . esc_url( get_permalink() ) . '" class="nv-product-overlay-link' . esc_attr( $overlay ) . '" tabindex="0" aria-label="' . esc_html( get_the_title() ) . ' ' . esc_attr__( 'Product page', 'neve' ) . '">';
